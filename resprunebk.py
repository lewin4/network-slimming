...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='sewage',
    ...
    parser.add_argument('--model', default=r'newhao/model_best.pth.tar', type=str, metavar='PATH',
    ...
    model = get_uncompressed_model("resnet18", pretrained=False, num_classes=6)
    ...
    pruned_ratio = (pruned/total).cpu().item()
    ...
    newmodel = resnet(depth=args.depth, dataset=args.dataset)
    if args.cuda:
        newmodel.cuda()
