...
def main():
    ...
    parser.add_argument('--dataset', type=str, default='sewage', choices=["cifar10", "cifar100", "sewage"],
    ...
    parser.add_argument('--refine',
                        default=r'E:\LY\network-slimming\newhao\0.8pruned.pth.tar', type=str,
                        metavar='PATH',
    ...
    if args.refine:
        ...
        model = get_uncompressed_model("resnet18", pretrained=False, num_classes=args.num_classes, cfg=cfg)
